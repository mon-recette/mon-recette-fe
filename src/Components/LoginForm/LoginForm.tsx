...
const LoginForm = () => {
  ...
  return (
    ...
    <input
     ...
     <button className='log_button' tabIndex={0} data-test='submit-button' type="submit" value='submit' onClick={(event) => navigateLogin(event)}>Sign in</button>     <div className='big_break'></div>
